...
public class AlipayContainerLayout extends FrameLayout {
    ...
    public AlipayContainerLayout(Context context) {
//        super(context);
        this(context, null);
    }

    public AlipayContainerLayout(Context context, AttributeSet attrs) {
//        super(context, attrs);
        this(context, attrs, 0);
    }

    public AlipayContainerLayout(Context context, AttributeSet attrs, int defStyleAttr) {
    ...
    public void setDecorator(Decorator decorator) {
        ...
        this.addView(topLayout, new LayoutParams(ViewGroup.LayoutParams.MATCH_PARENT,
